  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.code === 'auth/invalid-credential') {
        description = 'The email or password you entered is incorrect. If you previously signed in with another provider, please use that method instead, or create a new account by signing up.';
      } else {
