...
function LandingPage() {
    ...
    const startSimulation = () => {
        ...
        typingInterval = setInterval(() => {
            if (currentIndex < fullQuestion.length) {
                setTypedText(fullQuestion.slice(0, currentIndex + 1));
                currentIndex++;
            } else {
                ...
                setTimeout(() => {
                    ...
                    const responseInterval = setInterval(() => {
                        if (responseIndex < fullAnswer.length) {
                            setAiResponse(fullAnswer.slice(0, responseIndex + 1));
                            responseIndex++;
                        } else {
  ...
  return (
    <div className="w-full overflow-x-hidden relative bg-gradient-to-br from-slate-950 via-purple-950/30 to-slate-950 text-white">
      {/* Vibrant animated background */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-1/2 -right-1/4 w-[800px] h-[800px] bg-gradient-to-r from-blue-500/30 to-cyan-500/30 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '8s' }} />
        <div className="absolute -bottom-1/2 -left-1/4 w-[800px] h-[800px] bg-gradient-to-r from-violet-500/30 to-purple-500/30 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '10s', animationDelay: '2s' }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-pink-500/30 to-rose-500/30 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '12s', animationDelay: '4s' }} />
      </div>
