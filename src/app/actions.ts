...
export async function ask(
  ...
  const prompt = `
    ...
    The context may contain content from multiple documents. Analyze the context to answer not just what is explicitly stated, but also to provide analysis and logical reasoning based on the text.
