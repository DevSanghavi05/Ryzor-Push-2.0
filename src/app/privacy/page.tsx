  ...
  return (
    <div className="container mx-auto py-12 px-4 md:px-6 pt-16">
      <Card className="max-w-4xl mx-auto">
        <CardHeader>
          <CardTitle className="text-3xl font-headline">Privacy Policy for Ryzor</CardTitle>
          <p className="text-muted-foreground">Last updated: {new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</p>
        </CardHeader>
        <CardContent className="prose prose-sm dark:prose-invert max-w-none">
          <p>This Privacy Policy describes how Ryzor ("we," "our," or "us") collects, uses, and discloses your information when you use our application (the "Service") and explains your privacy rights. By using the Service, you agree to the collection and use of information in accordance with this policy.</p>
          ...
          <ul>
            <li><strong>Basic Profile Information:</strong> Your name, email address, and profile picture. This is used to create and manage your Ryzor account and personalize your experience.</li>
          ...
          <p>Ryzor uses the collected data for the following purposes:</p>
          <ul>
          ...
          <p>We do not sell, trade, or otherwise transfer your personally identifiable information to outside parties. Your data is used solely for the purpose of providing and improving the Ryzor service.</p>
